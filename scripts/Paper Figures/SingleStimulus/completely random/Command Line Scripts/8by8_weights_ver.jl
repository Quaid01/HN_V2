...
record_data(convergences_64, parameters, "$(Int(sqrt(N)))by$(Int(sqrt(N)))_rand_RawData_V2_Weighted_val_$(s)_detail_$(times_done)_up2")
...
record_data(convergences_64_hn, parameters, "$(Int(sqrt(N)))by$(Int(sqrt(N)))_rand_RawData_HN_Weighted_val_$(s)_detail_$(times_done)_up2")
...
savefig(p, "$(Int(sqrt(N)))by$(Int(sqrt(N)))_and_Weighted_val_$(s)_detail_$(times_done)_up2.png")
plot(p)